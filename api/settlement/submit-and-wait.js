// api/settlement/submit-and-wait.js
...
import { submitAndWaitSignedSettlement } from "../../src/server/_lib/xrplSettlement.js";
...
export default async function handler(req, res) {
  try {
    ...
    const result = await submitAndWaitSignedSettlement({
      signedTransaction,
